...
Graphite components can be customized at a high level through design tokens. This gives you control over theme
...
Graphite components are built with CSS custom properties (sometimes referred to as CSS variables) for easy
...
make it easier than ever to override Graphite components to match a brand or theme.
...
:root {
	...
	--gr-font-family: -apple-system, BlinkMacSystemFont, "Helvetica Neue",
		"Roboto", sans-serif;
}
```
